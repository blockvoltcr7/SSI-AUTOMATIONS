...
export const metadata: Metadata = {
  ...
  description:
    "Learn how SSI Automations handles visitor data for our AI learning hub. Our commitment to your privacy.",
};

export default function PrivacyPage() {
  const words = [{ text: "Privacy" }, { text: "Policy" }];
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-2xl shadow-lg overflow-hidden border border-neutral-200 dark:border-neutral-800 p-8 md:p-12">
              <div className="prose prose-gray dark:prose-invert max-w-none">
                ...
                <p className="mb-4">
                  ...
                  curates links to AI learning resources. We collect minimal
                  information:
                </p>
                <ul className="list-disc pl-6 mb-6">
                  <li>
                    Basic analytics data (page views, referral sources, general
                    location)
                  </li>
                  <li>
                    Technical information (browser type, device type, IP
                    address)
                  </li>
                ...
                <p className="mb-6">
                  ...
                  addresses, or phone numbers as we do not offer accounts,
                  services, or purchases on this site.
                </p>
                ...
                <p className="mb-6">
                  Our website contains links to third-party educational
                  platforms and resources. We are not responsible for the
                  privacy practices of these external sites. When you click on a
                  link to a third-party site, you will be subject to that site's
                ...
                <p className="mb-6">
                  We do not sell, trade, or rent visitor information to third
                  parties. We do not share any personal information because we
                  do not collect it. Anonymous analytics data may be shared with
                ...
                <p className="mb-6">
                  ...
                  activity on our website. These are used for analytics and to
                  improve user experience. You can instruct your browser to
                ...
                <p className="mb-6">
                  ...
                  limited data we collect. However, no method of transmission
                ...
                <p className="mb-6">
                  Our website is not directed to individuals under 13, and we do
