...
export function ContactForm() {
  ...
  const inputClasses =
    "block w-full bg-white dark:bg-neutral-800 px-4 rounded-lg border border-neutral-200 dark:border-neutral-700 py-2.5 shadow-sm text-black placeholder:text-neutral-400 focus:ring-2 focus:ring-primary focus:border-primary focus:outline-none sm:text-sm sm:leading-6 dark:text-white transition duration-200";
  const labelClasses =
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <select id="timeline" className={inputClasses} {...field}>
