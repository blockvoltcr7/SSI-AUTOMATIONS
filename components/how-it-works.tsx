...
export const HowItWorks: React.FC = () => {
  const steps = [
    ...
    },
    {
      ...
      description:
        "Based on your needs, we design a custom voice agent + automation plan.",
    },
    {
      emoji: "✅",
      title: "You Approve the Setup",
      description:
        "You review everything before launch — we'll make any adjustments needed.",
    },
    {
      emoji: "🚀",
    ...
    },
    {
      ...
      description:
        "While your 24/7 AI team handles customer calls, bookings, and backend tasks.",
    },
  ];
  ...
  return (
    <div
      id="how-it-works"
      className="w-full max-w-6xl mx-auto mt-20 px-4 sm:px-6 md:px-8 relative z-10"
    >
      {/* Divider */}
      ...
      >
        ...
        <p className="text-neutral-400 max-w-2xl mx-auto text-base md:text-lg">
          Our simple process to get your AI agents and automations up and
          running
        </p>
      </motion.div>
